...
object DetailDestination : DestinasiNavigasi {
    ...
    override val titleRes = "Detail Laptop"
    const val laptopId = "itemId"
    val routeWithArgs = "$route/{$laptopId}"
}
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            laptop  = detailUIState.addEvent.toLaptop(), modifier = Modifier.fillMaxWidth()
        )
...
@Composable
fun ItemDetails(
    laptop: Laptop, modifier: Modifier = Modifier
) {
    Card(
